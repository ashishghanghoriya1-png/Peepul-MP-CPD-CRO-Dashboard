...
<style>
    ...
    /* Sidebar Input Selectbox & Dropdown Popovers */
    ...
    /* Systematic Main Canvas Headings & Text */
    h1, h2, h3, h4, h5, h6 {
        color: #0F172A !important;
        font-family: 'Segoe UI', sans-serif;
        font-weight: 800 !important;
    }
    p, label, span, caption {
        color: #1E293B !important;
    }
    
    /* Main Canvas Inputs (Text Input, Selectbox, Sliders) */
    ...
    .briefing-card p, .briefing-card li, .briefing-card b {
        color: #1E293B !important;
    }
...
def apply_systematic_chart_theme(fig, title=""):
    fig.update_layout(
        title=dict(text=f"<b>{title}</b>", font=dict(size=15, color="#0F172A", family="Segoe UI")),
        paper_bgcolor="#FFFFFF",
        plot_bgcolor="#F8FAFC",
        font=dict(color="#1E293B", size=12),
        margin=dict(l=20, r=20, t=45, b=20),
        xaxis=dict(gridcolor="#E2E8F0", title_font=dict(color="#0F172A", size=12, family="Segoe UI"), tickfont=dict(color="#1E293B")),
        yaxis=dict(gridcolor="#E2E8F0", title_font=dict(color="#0F172A", size=12, family="Segoe UI"), tickfont=dict(color="#1E293B")),
        legend=dict(font=dict(color="#0F172A", size=12), bgcolor="rgba(255,255,255,0.8)")
    )
    return fig
